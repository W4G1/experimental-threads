...
const transformer: ts.TransformerFactory<ts.SourceFile | ts.Bundle> = (
  context,
) => {
...
const packageJson = {
  ...
  repository: {
    type: "git",
    url: "git+https://github.com/W4G1/experimental-threads.git",
  },
  license: "MIT",
  bugs: {
    url: "https://github.com/W4G1/experimental-threads/issues",
  },
  type: "module",
  exports: {
    ".": {
